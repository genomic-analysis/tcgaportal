...
m1F=cbind(dm[9,which(dm[7,]=="Stage I")])
m2F=cbind(dm[9,which(dm[7,]=="Stage II")])
m3F=cbind(dm[9,which(dm[7,]=="Stage III")])
m4F=cbind(dm[9,which(dm[7,]=="Stage IV")])

a1<-data.frame(group="I",value=log2(as.numeric(m1F)))
b1<-data.frame(group="II",value=log2(as.numeric(m2F)))
c1<-data.frame(group="III",value=log2(as.numeric(m3F)))
d1<-data.frame(group="IV",value=log2(as.numeric(m4F)))
